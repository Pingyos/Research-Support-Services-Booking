...
$client_id = 'kJ4G50AGcH6kegNvpyWjXPERVHpH1mxWjs577Mrk';        // The client ID assigned to you by the provider
$client_secret = 'gaNYS3AD8xZcyA5GdpYxM3R2kmaYnRxPgMcXbT81';    // The client secret assigned to you by the provider
$redirect_uri = 'https://app.nurse.cmu.ac.th/booking/login.php';                // redirect_uri (This file url)
